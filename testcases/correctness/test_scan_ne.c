...
char testval;	
	...
	printf("We test scan by printing all rec IDs with value != 2550 (number of printed recIDs should be 999)\n");
	int val = 2550;
	int numOfRecords = 0;
	sd = AM_OpenIndexScan(fd,INT_TYPE,sizeof(int),NE_OP,(char *)&val);
