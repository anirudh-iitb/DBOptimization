...
char testval;	
	...
	printf("We test scan by printing all rec IDs with value < 2634(the number of printed recIDs should be 633)\n");
	int val = 2634;
	int numOfRecords = 0;
	sd = AM_OpenIndexScan(fd,INT_TYPE,sizeof(int),LT_OP,(char *)&val);
