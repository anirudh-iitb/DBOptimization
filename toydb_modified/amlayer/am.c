...
char *key; /* returns the key to be filled in the parent */
{
	...
	// printf("Header number keys is %d\n",header->numKeys);
	...
	AM_Check;
	totalNumberOfPages++;
	// printf("THe new page number is %d\n",tempPageNum);
	...
	// 	printf("vnsbds\n");
	// }
	// printf("The next page leaf is %d\n",tempPageNum);
	...
	if ((*pageNum) == AM_RootPageNum)
	{
		...
		AM_Check;
		totalNumberOfPages++;
		// printf("Page number of root is %d\n",tempPageNum1);
