...
char testval;	
	...
	printf("We test scan by printing all rec IDs with value >= 2680(the number of printed recIDs should be 321)\n");
	int val = 2680;
	int numOfRecords = 0;
	sd = AM_OpenIndexScan(fd,INT_TYPE,sizeof(int),GE_OP,(char *)&val);
